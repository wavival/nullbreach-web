...
/**
 * Design tokens mirror the SPA's `../tailwind.config.ts` so the landing keeps
 * the exact NullBreach brand identity. Kept self-contained (not imported from
 * the parent) so this project builds and deploys on its own.
 */
const config: Config = {
  darkMode: ["class"],
  ...
  theme: {
    ...
    container: {
      center: true,
      padding: { DEFAULT: "12px", md: "16px", lg: "24px" },
      screens: { "2xl": "1200px" },
    },
    extend: {
      colors: {
      ...
      fontSize: {
        h1: ["32px", { lineHeight: "1.2", letterSpacing: "-0.5px", fontWeight: "700" }],
        h2: ["28px", { lineHeight: "1.2", letterSpacing: "-0.3px", fontWeight: "700" }],
